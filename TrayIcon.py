...
class SysTrayIcon(object):
    ...
    def activation(s):
        ...
        s.notify_id = None
        s.refresh(title='多功能小键盘软件已最小化到托盘！', msg='点击小键盘图标重新打开', time=500)
...
class _Main:  # 调用SysTrayIcon的Demo窗口
    ...
    def Hidden_window(s, icon=ABSPATH+r'\img\keyboard.ico', hover_text="SysTrayIcon.py Demo"):
    # def Hidden_window(s, icon= r'./img/keyboard.ico', hover_text="SysTrayIcon.py Demo"):
